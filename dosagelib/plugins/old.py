...
class Renamed(Scraper):
    ...
    def getmodules(cls):
        return (
            ...
            cls('Katbox/Draconia', 'Draconia'),
            cls('Katbox/Eorah', 'StudioKhimera/Eorah'),
            ...
            cls('Katbox/UberQuest', 'StudioKhimera/UberQuest'),
            ...
            cls('WhatWeRememberMost', 'SmackJeeves/WhatWeRememberTheMost'),
