...
class MangaDex(_ParserScraper):
    ...
    def getmodules(cls):
        return (
            ...
            cls('JitsuWaOreSaikyouDeshita', '9484b1fd-0271-4c9b-b096-7e313823058e'),
            ...
            cls('KimiToKoeteKoiNiNaru', 'a43bfc8f-3daf-4aba-bb2e-284109cbc03b'),
            cls('KiNiNatteruHitoGaOtokoJanakatta', '9d3d3403-1a87-4737-9803-bc3d99db1424'),
            ...
            cls('OsananajimiNiNajimitai', '20c45e17-7184-4942-814d-4caa8f94faa1'),
